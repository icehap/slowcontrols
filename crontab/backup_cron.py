...
def perform_backup(file_list):
    ...
    print(today)
    backup_path = f"/home/icehap-daq/backup/{today}/"
    ...
    for file in file_list:
        ...
        remote_backup_path = "icecube@grappa.phys.chiba-u.jp:/misc/home/icecube/backup_icehap-daq/"
...
if __name__ == "__main__":
    ...
    log_file = "/home/icehap-daq/backup/logs.txt"
